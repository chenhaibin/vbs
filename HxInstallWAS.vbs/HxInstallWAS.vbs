' ***********************************************************
' Name    : HxInstallWAS.vbs 
' Author  : Adrian Farnell
' Date    : 24.08.2003
' Version : 1.0
' Notes   : Script "tailors" response file for each server.
'
...
Dim sFileName, sNewFile, strLine, strIP

sFileName = "WASv1_0responsefile.txt"
sNewFile = "wasfile.txt"
...
Do while ofile.atendofstream <> true
	...
	if InStr (strLine, "VBDefaultNodeVB") <> 0 then
		strLine = Replace (strLine, "VBDefaultNodeVB", oWshNetwork.ComputerName)
		oNewFile.WriteLine strLine
	elseif Instr (strLine, "VB127.0.0.1VB") <> 0 then
	
		strLine = Replace (strLine, "VB127.0.0.1VB", oWshNetwork.ComputerName)
		oNewFile.WriteLine strLine
