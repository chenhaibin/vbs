...
'Dim strings
Dim strNTVer, strSPVer, intReturn
...
if strNTver = "4.0" and lcase (strSPver) = "service pack 4" then 
	wscript.echo "Not at the correct service pack"
end if

if strNTver = "5.1" and lcase (strSPver) = "service pack 1" then 
	wscript.echo "Applying hotfix...."
