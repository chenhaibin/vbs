...
'
' Amendments
' - James Taylor 20/10/03 : Aditional code to remove patchs
'
'==========================================================
...
if strNTver = "4.0" and lcase (strSPver) = "service pack 6" then 
	...
	intReturn = objshell.run (strPath & "WindowsNT4-KB828035-x86-ENU.exe -y -q -z",1, TRUE) 
...
elseif strNTver = "5.0" and lcase (strSPver) = "service pack 2" then 
	...
	intReturn = objshell.run (strPath & "Windows2000-KB828035-x86-ENU-sp2.exe -quiet  -uninstall -norestart",1, TRUE) 
	wscript.echo "Script returned - " & intReturn
	
elseif strNTver = "5.0" and lcase (strSPver) = "service pack 3" then 
	wscript.echo "Applying hotfix for W2K SP3"
	intReturn = objshell.run (strPath & "Windows2000-KB828035-x86-ENU-sp3-sp4.exe -quiet  -uninstall -norestart",1, TRUE) 
	wscript.echo "Script returned - " & intReturn
