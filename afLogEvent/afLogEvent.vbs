...
' -----------------------------------( insert code here )-----------------------------------------
	...
	strLogYYYY = Left (objEvent.TimeWritten, 4)
	strLogMM = Mid (objEvent.TimeWritten, 5, 2)
	strLogDD = Mid (objEvent.TimeWritten, 7, 2)
	strLogHH = Mid (objEvent.TimeWritten, 9, 2)
	strLogMin = Mid (objEvent.TimeWritten, 11,2)

	subDebugMsg strLogDD & "/" & strLogMM & "/" & strLogYYYY
