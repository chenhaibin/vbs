' ***********************************************************
' Name    : AfDelProcess.vbs
' Author  : Adrian Farnell
' Date    : 14.11.2002
' Version : 1.0
' Notes   : Logs each process Deleted
'
...
strLogDir = "c:\temp\logs\DeleteProcess"
...
sub subLogtoFile (strMsg, strLogDir)
	...
	if ofso.fileexists (strLogDir & "\DelProcess_" & oWshNetwork.Computername &"_"& strYYYY & strMM & strDD & ".log") = true then
		subDebugMsg "file does exist"
		
		'open file for appending
		set ofile = ofso.opentextfile (strLogDir & "\DelProcess_" & oWshNetwork.Computername &"_"& strYYYY & strMM & strDD & ".log",8)
	else
		subDebugMsg "file doesn't exist"
		
		'create file
		set ofile = ofso.createtextfile (strLogDir & "\DelProcess_" & oWshNetwork.Computername &"_"& strYYYY & strMM & strDD & ".log")
	end if
