...
For Each objLogfile in colLogFiles
    ...
    errBackupLog = objLogFile.BackupEventLog(strLogDir & "\" & Ucase (OWshNetwork.computername) & "_" & strYYYY & strMM & strDD & "app.evt")
    ...
    Else
	subDebugMsg "Clearing Application EventLogs"
...
For Each objLogfile in colLogFiles
    ...
    errBackupLog = objLogFile.BackupEventLog(strLogDir & "\" & Ucase (OWshNetwork.computername) & "_" & strYYYY & strMM & strDD & "Sys.evt")
    ...
    Else
	subDebugMsg "Clearing System EventLogs"
        'objLogFile.ClearEventLog()
...
For Each objLogfile in colLogFiles
    ...
    errBackupLog = objLogFile.BackupEventLog(strLogDir & "\" & Ucase (OWshNetwork.computername) & "_" & strYYYY & strMM & strDD & "sec.evt")
    ...
    Else
	subDebugMsg "Clearing Security EventLogs"
        'objLogFile.ClearEventLog()
...
sub subTestRun
	...
	call subCreateDir ("c:\temp\logs\test2")
	call SubErrMsg ("I've Errored")

end sub

sub subCreateDir (strLogDir)
