...
' Date    : 26/11/2002
' Version : 1.0
' Notes   : Decides what to run at logon dependent on OS/machine name
'
...
Select Case Ucase (oWshNetwork.ComputerName)
	
	case "NTW324100"
		subDebugMsg "Running on my laptop"
		subStart2k
	case "NTW302464"
		subDebugMsg "Running on my desktop"
		subStartXp
	case else
		subDebugMsg "Running on something else"
		subStartNT
end select 
