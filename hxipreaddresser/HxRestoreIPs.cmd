...
echo if this was not a standard RFS web server (ie. not changing e100b2), this registry log will be wrong>>log.txt
echo once the server has been rebooted check the ip addresses manually >>log.txt
